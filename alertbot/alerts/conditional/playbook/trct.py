...
# ---------------------------------- Specific Calculations ------------------------------------ #   
    def exp_range(self):
        ...
        logger.debug(f" TRCT | exp_range | Product: {self.product_name} | EXP_RNG: {exp_range} | EXP_HI: {exp_hi} | EXP_LO: {exp_lo}")
    ...
    def total_delta(self):
        ...
        logger.debug(f" TRCT | total_delta | TOTAL_DELTA: {total_delta}")
        return total_delta   
...
# ---------------------------------- Driving Input Logic ------------------------------------ #   
    def input(self):
        ...
        logger.debug(f" TRCT | input | Product: {self.product_name} | LOGIC: {logic}")
